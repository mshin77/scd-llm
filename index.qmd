...
[Figure 4](topic_modeling/docs_topics.html) <iframe src="topic_modeling/docs_topics.html" width="800" height="600"></iframe>

[Figure 5](topic_modeling/fig_cosine_sim.html) <iframe src="topic_modeling/fig_cosine_sim.html" width="800" height="600"></iframe>

# Evolution of Research

[Figures S1 to S6](https://scd-network.dev)<iframe src="https://scd-network.dev" width="800" height="1000"></iframe>
...
```{r, echo=FALSE, fig.width=14, fig.height=14, eval=FALSE}
...
[Figure 6](evolution/new_word_plot.html)
...
```{r, echo=FALSE, eval=FALSE}
save(new_word_count_df, overdispersion_ratio, new_word_plot, model_new_word, file = "evolution/model_new_word.RData")
```
