...
```{r, eval=FALSE, echo=FALSE, fig.width=14, fig.height=12} 
...
new_word_plot <- plotly::ggplotly(new_word_gg, height = 800, width = 1400) %>% 
 plotly::layout(
    legend = list(
      orientation = "h",
      x = 0.5,
...
ggsave('evolution/new_word_gg.png',
       width = 14, height = 12, dpi = 300, plot = new_word_gg)
```
