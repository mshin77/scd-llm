...
```{r, echo=FALSE}
# new_word_count_df <- read_excel("../word_network/new_word_count_df.xlsx")
```
...
```{r, echo=FALSE}
save(new_word_count_df, new_word_plot, word_usage_summary, model_new_word, model_new_word_results, overall_means, topic_means, file = "evolution/bayes_model.RData")
```
