...
**Web of Science (All Fields):** Single-case design AND technology terms

**Single-case design (18 terms):**
```
("alternat* treatment* design" OR "applied behavior* analys*" OR 
"chang* criteri* design" OR "combin* design" OR "multielement design" OR 
"multiple* baseline* design" OR "multiple* probe* design" OR 
"revers* design" OR "single* case* data" OR "single* case* design" OR 
"single* case* experimental design" OR "single* case* research" OR 
"single* subject* data" OR "single* subject* design" OR 
"single* subject* experimental design" OR "single* subject* research" OR 
"withdraw* design")
```

**Technology (49 terms):**
```
("3D" OR "anchored*" OR "animat*" OR "artificial* intelligen*" OR 
"augment*" OR "automat*" OR "blended*" OR "chatbot" OR "computer*" OR 
"computing" OR "cyber*" OR "deep learn*" OR "device*" OR "digital*" OR 
"Excel" OR "eye* track" OR "game*" OR "gamificat*" OR "gaming*" OR 
"immersive" OR "internet" OR "iPad*" OR "machine*" OR "mechanic*" OR 
"metaverse" OR "mixed real*" OR "mobile*" OR "online" OR "programming" OR 
"python" OR "R program*" OR "real* time*" OR "robot" OR "shiny" OR 
"smart*" OR "software*" OR "speech generat*" OR "speech recogn*" OR 
"speech*to*text" OR "synchronous*" OR "tablet*" OR "technolog*" OR 
"tele*" OR "text*to*speech" OR "three* dimension*" OR "video*" OR 
"virtual*" OR "web*" OR "wireless")
```
...
[<i class="fas fa-code"></i> Code](single_case/index.html){.hover-effect style="color: #6D6D6D; text-decoration: none;"} \| Figure 2 (A). Single Case Design Classification

![](files/single-case-results.png)

#### `Step 2. Text classification for using technology`

[<i class="fas fa-code"></i> Code](technology_use/index.html){.hover-effect style="color: #6D6D6D; text-decoration: none;"} \| Figure 2 (B). Technology Use Classification
...
[<i class="fas fa-code"></i> Code](topic_modeling/index.html){.hover-effect style="color: #6D6D6D; text-decoration: none;"} \| [Figure 4](topic_modeling/docs_topics.html){.hover-effect style="color: #6D6D6D; text-decoration: none;"} \| [Figure 5](topic_modeling/fig_cosine_sim.html){.hover-effect style="color: #6D6D6D; text-decoration: none;"}

::: {.iframe-container style="width: 100%; max-width: 800px; height: 800px; margin: 0 auto;"}
<iframe src="topic_modeling/docs_topics.html" style="width: 100%; height: 100%; border: none;">
