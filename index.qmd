...
```{r}
load("novelty/model_new_word.RData")
```
...
[Figure 6](https://scd-network.dev)<iframe src="https://scd-network.dev" width="800" height="1000"></iframe>

# Novelty 

[Code](novelty/index.html)

```{r, eval=FALSE, echo=FALSE}
new_word_count_df <- read_excel("novelty/new_word_count_df.xlsx")
```
...
# write.xlsx(new_word_count_df, "novelty/new_word_count_df_updated.xlsx", rowNames = FALSE)
```
...
suppressWarnings(htmlwidgets::saveWidget(
  ...
  file = "novelty/new_word_plot.html",
  selfcontained = TRUE))

ggsave('novelty/new_word_gg.png',
       width = 14, height = 12, dpi = 300, plot = new_word_gg)
```

[Figure 7](novelty/new_word_plot.html)
...
```{r, echo=FALSE, eval=FALSE}
save(new_word_count_df, new_word_plot, model_new_word, file = "novelty/model_new_word.RData")
```
