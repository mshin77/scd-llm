...
#### Text classifier and prediction for screening

-   [Code: Using single case design](screening_single_case/index.html)

    ![](files/single-case-results.png)

-   [Code: Using of technology](screening_technology_use/index.html)

    ![](files/technology-use-results.png)

#### Filtering via regular expressions

-   [Code: Targeting single case design methodology](methodology/index.html)

    ```         
    A list of 77 wild expressions, composed with regular expressions to process
    patterns = [
      r'\banaly\w*',
      r'\bartificial\w*\s+intelligen\w*',
      r'\bbehavior\w*\s+change\w*',
      r'\bcalculate\w*,
              ...
    ]
    ```
...
```{r, echo=FALSE, width=10, height=8}
...
[Code: Topic modeling via large language models](topic_modeling/index.html)

<iframe src="topic_modeling/results/fig_cluster.html" width="750" height="600"></iframe>

<iframe src="topic_modeling/results/topic_model_fig.html" width="750" height="600"></iframe>

<iframe src="topic_modeling/results/topic_word_barchart.html" width="750" height="900"></iframe>

<iframe src="topic_modeling/results/docs_topics.html" width="750" height="600"></iframe>

<iframe src="topic_modeling/results/heatmap.html" width="750" height="600"></iframe>

<iframe src="topic_modeling/results/hierarchical_topics_fig.html" width="750" height="600"></iframe>

## N-grams

<iframe src="topic_modeling/results/ngram_count_fig.html" width="750" height="750"></iframe>

<iframe src="topic_modeling/results/ngram_proportion_fig.html" width="750" height="750"></iframe>

## Word Networks

Dynamic Plot: <https://scd-network.dev>

<iframe src="https://scd-network.dev" width="750" height="800"></iframe>
:::
