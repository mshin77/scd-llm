...
#### Estimate the Model (Reference: Topic 4)
...
model_new_word_results_apa <- model_new_word_results %>%
  ...
  select(Variable, `Estimate (SD)`, `Estimate 95% CI`, IRR, `IRR 95% CI`)
...
save(new_word_count_df, model_new_word, model_new_word_results_apa, new_word_gg,
     word_usage_summary, new_word_plot,
